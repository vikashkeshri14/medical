...
export default function WhyChooseUs() {
  ...
  return (
    <div class="ltn__feature-area section-bg-1 pt-115 pb-40">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 col-sm-6 col-12">
            <ul className="ltn__list-item-1 d-flex flex-column ltn__list-item-1-before--- clearfix">
              <li className="self-align-center choose">
                <img src="assets/img/others/why_choose_us_icon6-2.png" />
                <span className="font-weight-700 font-15 pl-10 text-black ">
              ...
              <li className="self-align-center choose">
                <img src="assets/img/others/why_choose_us_icon5-2.png" />
                <span className="font-weight-700 font-15 pl-10 text-black ">
